...
export default function Index() {
  ...
  return (
    <>
      <section className="">
        <form onSubmit={handleSubmit(onSubmit)} className=" h-[328px] ">
          <section className="xl:flex justify-center xl:gap-6 grid">
            <section className="flex flex-col xl:gap-6 gap-3 justify-center">
