      ...
      >
        ...
        <section className="xl:col-span-4">
          ...
          <ul className="text-[14px] list-decimal leading-10 pr-[40px] text-justify">
            <li>
              در انتخاب تعهدات بیمه دقت نمایید هر مبلغی را که به عنوان بیمه
              امداد مشخص می کنید برای استفاده در طول سال هست پس در انتخاب مبلغ
              تعهدات دقت شود پیشنهاد برای انتخاب تعهدات :
              <ul>
                <li>الف) برای خودروهای ایرانی از ۵ تا ۱۰ میلیون تومان پوشش تعهدات انتخاب شود یا بیشتر، مثال محاسباتی : برای ۵ میلیون پوش تعهدات بیمه فقط مبلغ ۲۵۰ هزار تومان پرداخت می شود (یعنی ۵٪ تعهدات)</li>
                <li>ب) برای خودروهای شاسی خارجی و چینی و ایرانی از ۱۵ تا ۲۵ میلیون تومان پوشش تعهدات انتخاب شود. مثال محاسباتی: برای ۲۵ میلیون تومان پوشش تعهدات فقط مبلغ ۱۲۵۰۰۰۰ حق بیمه امداد پرداخت می شود (یعنی ۵٪ حق بیمه تعهدات پوششی).</li>
              </ul>
            </li>

            <li>
              حق بیمه ۵٪ از هزینه تعهدات تا پایان سال ۱۴۰۳ می باشد از شروع
              سال جدید ۱۴۰۴ به حق بیمه ۱۰٪ افزایش خواهد یافت پس دقت نمایید قبل
              از سال جدید تعهدات بیمه امداد خود را خریداری نمایید . (در نظر
              داشته باشید این تخفیف فقط به مناسبت ۲۲ بهمن و عید نوروز می باشد).
            </li>
            <li>
              طرح بیمه امداد در حمل خودرو برای اولین بار راه اندازی شده و
              هدف آن کوتاه کردن دستان افراد سود جو می باشد تا شما هزینه های
              هنگفت در زمان حمل به اجبار پرداخت ننمایید.
            </li>
            <li>
              تنها سامانه پیامکی امداد خودرو کشور ۱۰۰۰۰۱۵۹۳ بوده و سایر
              پیامک های از سامانه های دیگر فاقد اعتبار می باشد .
            </li>
          </ul>
        </section>
        {/* -------------------Submit------------------- */}
