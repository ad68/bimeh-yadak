...
export default function Index({ children, open, onClose, width, title }) {
  ...
  //
  return (
    <section ref={modalWrapper} className="fixed h-full w-full top-0 left-0 hidden items-center justify-center z-[1000]">
      ...
      <section ref={modalBox} className="h-auto max-h-[95%] overflow-auto py-[60px] px-[30px] min-h-[100px] bg-white mx-auto z-[1000] rounded-[10px] scale-0 transition-all duration-300" style={{ width: width ? width : 500 }}>
